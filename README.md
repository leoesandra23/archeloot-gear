...
## ArcheLoot / IPS deployment

See `DEPLOY-IPS.md` and `PRODUCTION-CHECKLIST.md`. The dedicated `/embed` route is the recommended surface for an Invision Community Pages integration.
