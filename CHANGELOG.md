...
- Added standalone `/embed` route.
- Added responsive embed header.
- Added IPS integration guide and paste-ready iframe snippet.
- Kept calculator state and sharing behavior intact.
